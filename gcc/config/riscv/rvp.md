...
(define_mode_iterator VPHI  [(V2HI "") (V4HI "TARGET_64BIT")])
...
(define_expand "kdmbb<mode>"
  [(match_operand:SI 0 "register_operand" "")
   (match_operand:VPHI 1 "register_operand" "")
   (match_operand:VPHI 2 "register_operand" "")]
  "TARGET_ZPN"
{
  emit_insn (gen_kdm<mode>_internal (operands[0], operands[1], operands[2],
				GEN_INT (0), GEN_INT (0)));
  DONE;
}
[(set_attr "type" "dsp")])

(define_expand "kdmbt<mode>"
  [(match_operand:SI 0 "register_operand" "")
   (match_operand:VPHI 1 "register_operand" "")
   (match_operand:VPHI 2 "register_operand" "")]
  "TARGET_ZPN"
...
(define_insn "kdm<mode>_internal"
  [(set (match_operand:SI 0 "register_operand"                      "=   r,   r,   r,   r")
	(ashift:SI
	(mult:SI
		(sign_extend:SI
	(vec_select:HI
		(match_operand:VPHI 1 "register_operand"          "   r,   r,   r,   r")
		(parallel [(match_operand:SI 3 "imm_0_1_operand"  " C00, C00, C01, C01")])))
		(sign_extend:SI
	(vec_select:HI
		(match_operand:VPHI 2 "register_operand"          "   r,   r,   r,   r")
