...
extern const char *riscv_output_pop (rtx);
#ifdef RTX_CODE
...
extern void riscv_expand_prologue_push (void);
...
extern bool regno_p(rtx, unsigned);
...
rtl_opt_pass * make_pass_zce_push (gcc::context *ctxt);
