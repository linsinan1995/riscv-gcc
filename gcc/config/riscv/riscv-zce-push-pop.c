...
int get_return_value (rtx pat, int *retval)
{
...
class pass_zce_push_pop : public rtl_opt_pass
{
public:
  pass_zce_push_pop (gcc::context *ctxt)
    : rtl_opt_pass (pass_data_zce_push_pop, ctxt)
  {}
...
rtl_opt_pass *
make_pass_zce_push_pop (gcc::context *ctxt)
{
  return new pass_zce_push_pop (ctxt);
}
