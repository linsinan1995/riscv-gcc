...
/* Define __builtin_riscv_<NAME>, which is a RISCV_BUILTIN_DIRECT function
   mapped to instruction CODE_FOR_riscv_<INSN>,  FUNCTION_TYPE and AVAIL
   are as for RISCV_BUILTIN.  */
#define RVP_DIRECT_BUILTIN(INSN, NAME, FUNCTION_TYPE, AVAIL)			\
  RISCV_BUILTIN (INSN, #NAME, RISCV_BUILTIN_DIRECT, FUNCTION_TYPE, AVAIL)

/* Define __builtin_riscv_<NAME>, which is a RISCV_BUILTIN_DIRECT_NO_TARGET function
   mapped to instruction CODE_FOR_riscv_<INSN>,  FUNCTION_TYPE and AVAIL
   are as for RISCV_BUILTIN.  */
#define RVP_NO_TARGET_BUILTIN(INSN, NAME, FUNCTION_TYPE, AVAIL)			\
  RISCV_BUILTIN (INSN, #NAME, RISCV_BUILTIN_DIRECT_NO_TARGET, FUNCTION_TYPE, AVAIL)
