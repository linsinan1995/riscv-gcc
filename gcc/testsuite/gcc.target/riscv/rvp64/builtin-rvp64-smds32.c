...
int32_t smds32 (uint32_t ra, uint32_t rb)
{
  return __rv__smds32 (ra, rb);
}

static __attribute__ ((noinline))
int32_t v_smds32 (int32x2_t ra, int32x2_t rb)
{
...
{
  int32_t va_p = 0;
  int32_t a = smds32 (0x8000000280000002, 0x8000000180000001);
  int32_t va = v_smds32 ((int32x2_t) {0xffff0002, 0xffff0002},
