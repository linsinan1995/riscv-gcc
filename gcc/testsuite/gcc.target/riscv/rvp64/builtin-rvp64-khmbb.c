...
int32_t khmbb (int ra, int rb)
{
  return __rv__khmbb (ra, rb);
}

static __attribute__ ((noinline))
int32_t v_khmbb (int16x4_t ra, int16x4_t rb)
{
...
main ()
{
  int32_t a = khmbb (0x0001f000, 0x00011000);
  int32_t v_sa = v_khmbb ((int16x4_t) {0xf777, 0xf111, 0, 0},
