...
int32_t kmabb (uint32_t rd, uint32_t ra, uint32_t rb)
{
  return __rv__kmabb (rd, ra, rb);
}

static __attribute__ ((noinline))
int32x2_t v_kmabb (int32x2_t rd, int16x4_t ra, int16x4_t rb)
{
  return __rv__v_kmabb (rd, ra, rb);
}

int
main ()
{
  int32_t a = kmabb (0x300000003, 0x8000000280000002, 0x8000000180000001);
