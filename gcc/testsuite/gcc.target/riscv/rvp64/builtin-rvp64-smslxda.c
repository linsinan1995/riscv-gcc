...
static __attribute__ ((noinline))
long long v_smslxda (long long t, int16x4_t a, int16x4_t b)
{
...
main ()
{
  long long a = smslxda (0x12345678ffffffffll, 0x6789000067890000, 0x1234000012340000);
  long long va = v_smslxda (0x12345678ffffffffll, (int16x4_t) {0, 0x6789, 0, 0x6789},
