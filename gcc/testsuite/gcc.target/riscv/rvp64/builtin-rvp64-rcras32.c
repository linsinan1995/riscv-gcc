...
uint32_t rcras32 (uint32_t ra, uint32_t rb)
{
  return __rv__rcras32 (ra, rb);
}

static __attribute__ ((noinline))
int32x2_t v_rcras32 (int32x2_t ra, int32x2_t rb)
{
  return __rv__v_rcras32 (ra, rb);
}
...
main ()
{
  ...
  uint32_t a = rcras32 (0x0001f0000001f000, 0x0001100000011000);
