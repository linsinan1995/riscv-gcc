...
int32_t kmmawt2 (int32_t rd, int32_t ra, int32_t rb)
{
  return __rv__kmmawt2 (rd, ra, rb);
}

static __attribute__ ((noinline))
int32x2_t v_kmmawt2 (int32x2_t rd, int32x2_t ra, int16x4_t rb)
{
...
main ()
{
  int32_t a = kmmawt2 (0, 0x8000000080000000, 0x8000000180000001);
  int32x2_t va = v_kmmawt2 ((int32x2_t) {0, 0},
