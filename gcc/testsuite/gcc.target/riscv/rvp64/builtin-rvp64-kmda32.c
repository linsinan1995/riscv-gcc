...
int32_t kmda32 (uint32_t ra, uint32_t rb)
{
  return __rv__kmda32 (ra, rb);
}

static __attribute__ ((noinline))
int32_t v_kmda32 (int32x2_t ra, int32x2_t rb)
{
...
main ()
{
  ...
  int32_t a = kmda32 (0x8000000280000002, 0x8000000180000001);
  int32_t va = v_kmda32 ((int32x2_t) {0xffff0002, 0xffff0002},
