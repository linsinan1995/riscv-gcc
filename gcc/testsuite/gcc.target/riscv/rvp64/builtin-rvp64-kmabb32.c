...
int32_t kmabb32 (uint32_t rd, uint32_t ra, uint32_t rb)
{
  return __rv__kmabb32 (rd, ra, rb);
}

static __attribute__ ((noinline))
int32_t v_kmabb32 (uint32_t rd, int32x2_t ra, int32x2_t rb)
{
...
main ()
{
  ...
  int32_t a = kmabb32 (0x300000003, 0x8000000280000002, 0x8000000180000001);
  int32_t va = v_kmabb32 (0x300000003,
