...
static const struct riscv_ext_version riscv_ext_version_table[] =
{
  ...
  {"p",   ISA_SPEC_CLASS_NONE, 0, 93},
  {"zpn", ISA_SPEC_CLASS_NONE, 0, 93},
  {"zprv", ISA_SPEC_CLASS_NONE, 0, 93},
  {"zpsf", ISA_SPEC_CLASS_NONE, 0, 93},
  /* Terminate the list.  */
...
static const riscv_ext_flag_table_t riscv_ext_flag_table[] =
{
  ...
  {"zprv", &gcc_options::x_target_flags, MASK_ZPRV},
  {"zpsf", &gcc_options::x_target_flags, MASK_ZPSF},
  {NULL, NULL, 0}
};
